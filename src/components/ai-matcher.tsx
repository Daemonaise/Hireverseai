  ...
  return (
    <Card className="w-full">
      <CardHeader>
        ...
        <CardDescription>Let our AI find the perfect freelance talent for you.</CardDescription>
      </CardHeader>
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)}>
          <CardContent className="space-y-4">
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel htmlFor="projectBrief" className="sr-only">
                    Project Brief
                  </FormLabel>
                  <FormControl>
                    <Textarea
                      ...
                      className="min-h-[120px] max-h-[250px] resize-y"
                    />
                  </FormControl>
                  <FormMessage />
                </FormItem>
            ...
            {!showFreelancerIdInput && (
                <div className="text-center pt-2">
                    <button
                        ...
                        className="text-xs text-muted-foreground hover:text-primary hover:underline focus:outline-none focus:text-primary focus:underline"
                    >
                        Have a specific freelancer ID?
                    </button>
                </div>
            )}
            ...
            <div className={cn(
                ...
                showFreelancerIdInput ? "max-h-40 opacity-100 pt-2" : "max-h-0 opacity-0"
            )}>
              <FormField
                control={form.control}
                name="freelancerId"
                    ...
                    <FormControl>
                      <div className="relative">
                         <Input
                           ...
                           {...field}
                           placeholder="Enter ID to assign a specific freelancer"
                         />
                         {field.value && (
                           <Button
                             type="button"
